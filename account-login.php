      ...
      <div class="container">
        ...
        <div class="column">
          <ul class="breadcrumbs">
            ...
            <li><a href="account-orders.php">Minha conta</a>
            </li>
            <li class="separator">&nbsp;</li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          if (isset($_GET["erro"])) {
            ...
            $codErro = explode("-", $erros);

          ?>
            <div class="alert alert-danger" role="alert">
              <ul>
                <?php
                foreach ($codErro as $key => $value) {
                    $message = "";
                    if($value == "001"){
                      $message = "E-mail já está em uso.";
                    }else if($value == "002"){
                      $message = "O CPF já encontrasse em uso";
                    }else if($value == "003"){
          ...
          <form class="row" method="post" action="./tray/controller/UsuarioController.php?acao=cadastrar">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label for="reg-ln">Como gostaria de ser chamado ?</label>
                <input class="form-control" type="text" id="reg-ln" name="apelido">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label for="reg-email">Cpf</label>
                <input class="form-control" type="number" id="reg-email" name="cpf" required>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label for="reg-phone">Data de nascimento</label>
                <input class="form-control" type="date" id="reg-phone" name="nascimento" required>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="reg-phone" name="telefone">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
